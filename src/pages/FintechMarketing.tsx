...
export default function FintechMarketing() {
                            ...
                            <div className="sectoral-split-layout">
                                ...
                                <div className="sectoral-card">
                                    ...
                                    <p style={{ fontSize: '0.9rem', color: '#4b5563', marginBottom: '20px' }}>
                                        FinTech Sektörü İçin Bütünleşik Dijital Pazarlama Çözümleri
                                    </p>
                                    <Link to="/hizmetlerimiz/fintech-butunlesik-dijital-pazarlama" className="sectoral-btn">Detaylı Bilgi</Link>
                                </div>
                            </div>
                        </div>
                    )
    ...
    const enConfig = {
        ...
        hero: {
            ...trConfig.hero,
            title: `360° Marketing Management for FinTech Companies`,
            subtitle: '',
                        ...
                        <div className="sectoral-tabs-content">
                            <div className="sectoral-split-layout">
                                ...
                                <div className="sectoral-card">
                                    ...
                                    <p style={{ fontSize: '0.9rem', color: '#4b5563', marginBottom: '12px' }}>
                                        Achieve success with Integrated Digital Marketing in the FinTech Sector. Get more engagement and more conversions through digital channel integration. Optimize your marketing investments with khilonfast.
                                    </p>
                                    <p style={{ fontSize: '0.9rem', color: '#4b5563', marginBottom: '20px' }}>
                                        Integrated Digital Marketing Solutions for the FinTech Sector
                                    </p>
                                    <Link to="/en/services/fintech-integrated-digital-marketing" className="sectoral-btn">Learn More</Link>
                                </div>
                            </div>
                        </div>
                    )
