...
export default function FleetRentalIntegratedMarketing() {
    ...
    useEffect(() => {
        document.title = 'Filo Kiralama için Bütünleşik Dijital Pazarlama'
    ...
    const config = {
        hero: {
            title: 'Filo Kiralama için Bütünleşik Dijital Pazarlama',
            subtitle: 'Filo Kiralama için bütünleşik pazarlama stratejileri ile markanızı büyütün!',
