...
export default function FleetRentalIntegratedMarketing() {
    ...
    useEffect(() => {
        document.title = 'Filo Kiralama Sektörü İçin Dijital Kanalları Tek Bir Stratejide Birleştirin!'
    ...
    const config = {
        hero: {
            title: 'Filo Kiralama Sektörü İçin Dijital Kanalları Tek Bir Stratejide Birleştirin!',
