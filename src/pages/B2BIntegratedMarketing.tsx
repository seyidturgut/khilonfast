...
export default function B2BIntegratedMarketing() {
    ...
    useEffect(() => {
        document.title = 'B2B için Bütünleşik Dijital Pazarlama'
    ...
    const config = {
        hero: {
            title: 'B2B için Bütünleşik Dijital Pazarlama',
            subtitle: 'B2B sektörü için bütünleşik pazarlama stratejileri ile markanızı büyütün!',
