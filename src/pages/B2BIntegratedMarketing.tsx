...
export default function B2BIntegratedMarketing() {
    ...
    useEffect(() => {
        document.title = 'B2B Sektörü İçin Dijital Kanalları Tek Bir Stratejide Birleştirin!'
    ...
    const config = {
        hero: {
            title: 'B2B Sektörü İçin Dijital Kanalları Tek Bir Stratejide Birleştirin!',
