...
export default function SoftwareIntegratedMarketing() {
    ...
    useEffect(() => {
        document.title = 'Teknoloji & Yazılım için Bütünleşik Dijital Pazarlama'
    ...
    const config = {
        hero: {
            title: 'Teknoloji & Yazılım için Bütünleşik Dijital Pazarlama',
            subtitle: 'Teknoloji & Yazılım için bütünleşik pazarlama stratejileri ile markanızı büyütün!',
