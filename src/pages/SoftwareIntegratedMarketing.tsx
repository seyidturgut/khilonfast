...
export default function SoftwareIntegratedMarketing() {
    ...
    useEffect(() => {
        document.title = 'Teknoloji & Yazılım Sektörü İçin Dijital Kanalları Tek Bir Stratejide Birleştirin!'
    ...
    const config = {
        hero: {
            title: 'Teknoloji & Yazılım Sektörü İçin Dijital Kanalları Tek Bir Stratejide Birleştirin!',
