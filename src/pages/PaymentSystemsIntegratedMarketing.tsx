...
export default function PaymentSystemsIntegratedMarketing() {
    ...
    useEffect(() => {
        document.title = 'Ödeme Sistemleri için Bütünleşik Dijital Pazarlama'
    ...
    const config = {
        hero: {
            title: 'Ödeme Sistemleri için Bütünleşik Dijital Pazarlama',
            subtitle: 'Ödeme Sistemleri için bütünleşik pazarlama stratejileri ile markanızı büyütün!',
