...
export default function PaymentSystemsIntegratedMarketing() {
    ...
    useEffect(() => {
        document.title = 'Ödeme Sistemleri Sektörü İçin Dijital Kanalları Tek Bir Stratejide Birleştirin!'
    ...
    const config = {
        hero: {
            title: 'Ödeme Sistemleri Sektörü İçin Dijital Kanalları Tek Bir Stratejide Birleştirin!',
