...
export default function InteriorDesignIntegratedMarketing() {
    ...
    useEffect(() => {
        document.title = 'Ofis & Tasarım Sektörü İçin Dijital Kanalları Tek Bir Stratejide Birleştirin!'
    ...
    const config = {
        hero: {
            title: 'Ofis & Tasarım Sektörü İçin Dijital Kanalları Tek Bir Stratejide Birleştirin!',
