...
export default function ManufacturingIntegratedMarketing() {
    ...
    useEffect(() => {
        document.title = 'Üretim Sektörü İçin Dijital Kanalları Tek Bir Stratejide Birleştirin!'
    ...
    const config = {
        hero: {
            title: 'Üretim Sektörü İçin Dijital Kanalları Tek Bir Stratejide Birleştirin!',
