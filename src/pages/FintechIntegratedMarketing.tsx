...
export default function FintechIntegratedMarketing() {
    ...
    useEffect(() => {
        document.title = 'FinTech Sektörü İçin Dijital Kanalları Tek Bir Stratejide Birleştirin!'
    ...
    const config = {
        hero: {
            title: 'FinTech Sektörü İçin Dijital Kanalları Tek Bir Stratejide Birleştirin!',
