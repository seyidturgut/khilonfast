...
export default function FintechIntegratedMarketing() {
    ...
    useEffect(() => {
        document.title = 'FinTech için Bütünleşik Dijital Pazarlama'
    ...
    const config = {
        hero: {
            title: 'FinTech için Bütünleşik Dijital Pazarlama',
            subtitle: 'FinTech için bütünleşik pazarlama stratejileri ile markanızı büyütün!',
