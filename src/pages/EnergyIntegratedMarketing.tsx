...
export default function EnergyIntegratedMarketing() {
    ...
    useEffect(() => {
        document.title = 'Enerji Sektörü İçin Dijital Kanalları Tek Bir Stratejide Birleştirin!'
    ...
    const config = {
        hero: {
            title: 'Enerji Sektörü İçin Dijital Kanalları Tek Bir Stratejide Birleştirin!',
