...
const AI_ANSWER_TR = {
    question: 'Enerji Sektörüne Özel Bütünleşik Dijital Pazarlama nedir?',
    answer: 'Enerji şirketlerinin SEO, arama reklamları, içerik ve sosyal medyayı tek stratejide birleştirerek bütçesini doğru kanallara yönlendirdiği dijital pazarlama hizmetidir. Sektöre özel Core, Growth ve Ultimate paketleriyle sunulur.'
};
const AI_ANSWER_EN = {
    question: 'What is Integrated Digital Marketing for the Energy Sector?',
    answer: 'A digital marketing service that combines SEO, search ads, content and social media into a single strategy so energy companies direct their budget to the right channels. Offered through sector-specific Core, Growth and Ultimate packages.'
};

export default function EnergyIntegratedMarketing() {
    const { t, i18n } = useTranslation('common')
    const isEn = i18n.language === 'en'
    const SECTOR_TR = 'Enerji'
    const SECTOR_EN = 'Energy'
