...
export default function EnergyIntegratedMarketing() {
    ...
    useEffect(() => {
        document.title = 'Enerji için Bütünleşik Dijital Pazarlama'
    ...
    const config = {
        hero: {
            title: 'Enerji için Bütünleşik Dijital Pazarlama',
            subtitle: 'Enerji sektörü için bütünleşik pazarlama stratejileri ile markanızı büyütün!',
