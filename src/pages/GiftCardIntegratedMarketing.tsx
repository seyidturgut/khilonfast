...
export default function GiftCardIntegratedMarketing() {
    ...
    useEffect(() => {
        document.title = 'Kurumsal Hediye Kartı için Bütünleşik Dijital Pazarlama'
    ...
    const config = {
        hero: {
            title: 'Kurumsal Hediye Kartı için Bütünleşik Dijital Pazarlama',
            subtitle: 'Kurumsal Hediye Kartı için bütünleşik pazarlama stratejileri ile markanızı büyütün!',
        ...
        breadcrumbs: [
            ...
            { label: 'Kurumsal Hediye Kartı Sektörü — Bütünleşik Dijital Pazarlama' }
        ],
        videoShowcase: {
            ...
            packages: [
                {
                    ...
                    features: [],
                    details: [
                        { title: t('serviceIDM.pricing.core.forWho'), description: t('serviceIDM.pricing.core.forWhoDesc'), icon: <HiUserGroup /> },
                        { title: t('serviceGTM.pricing.core.why'), description: t('serviceIDM.pricing.core.whyDesc'), icon: <HiRocketLaunch /> }
                    ],
                ...
                },
                {
                    ...
                    features: [],
                    details: [
                        { title: t('serviceIDM.pricing.core.forWho'), description: t('serviceIDM.pricing.growth.forWhoDesc'), icon: <HiUserGroup /> },
                        { title: t('serviceGTM.pricing.core.why'), description: t('serviceIDM.pricing.growth.whyDesc'), icon: <HiRocketLaunch /> }
                    ],
                    buttonText: t('pricing.buyNow')
                },
                {
                    ...
                    features: [],
                    details: [
                        { title: t('serviceIDM.pricing.core.forWho'), description: t('serviceIDM.pricing.ultimate.forWhoDesc'), icon: <HiUserGroup /> },
                        { title: t('serviceGTM.pricing.core.why'), description: t('serviceIDM.pricing.ultimate.whyDesc'), icon: <HiRocketLaunch /> }
                    ],
                    buttonText: t('pricing.buyNow')
                }
            ]
