...
export default function GiftCardIntegratedMarketing() {
    ...
    useEffect(() => {
        document.title = 'Kurumsal Hediye Kartı Sektörü İçin Dijital Kanalları Tek Bir Stratejide Birleştirin!'
    ...
    const config = {
        hero: {
            title: 'Kurumsal Hediye Kartı Sektörü İçin Dijital Kanalları Tek Bir Stratejide Birleştirin!',
