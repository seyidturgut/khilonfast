                        ...
                        <div className="sectoral-tabs-content">
                            <div className="sectoral-split-layout">
                                <div className="sectoral-split-video" style={{ display: 'flex', alignItems: 'center' }}>
                                    <img src="/images/hizmetlerimiz/butunlesik-dijital-pazarlama/hero.avif" alt="Üretim Bütünleşik Dijital Pazarlama" style={{ width: '100%', borderRadius: '16px', objectFit: 'cover' }} />
                                </div>
                ...
                },
                {
                    ...
                    content: (
                        <div className="sectoral-tabs-content">
                            <div className="sectoral-split-layout">
                                <div className="sectoral-split-video" style={{ display: 'flex', alignItems: 'center' }}>
                                    <img src="/images/hizmetlerimiz/butunlesik-dijital-pazarlama/hero.avif" alt="Manufacturing Integrated Digital Marketing" style={{ width: '100%', borderRadius: '16px', objectFit: 'cover' }} />
                                </div>
                                <div className="sectoral-card">
