...
export default function IndustrialFoodIntegratedMarketing() {
    ...
    useEffect(() => {
        document.title = 'Endüstriyel Gıda için Bütünleşik Dijital Pazarlama'
    ...
    const config = {
        hero: {
            title: 'Endüstriyel Gıda için Bütünleşik Dijital Pazarlama',
            subtitle: 'Endüstriyel Gıda için bütünleşik pazarlama stratejileri ile markanızı büyütün!',
