...
export default function IndustrialFoodIntegratedMarketing() {
    ...
    useEffect(() => {
        document.title = 'Endüstriyel Gıda Sektörü İçin Dijital Kanalları Tek Bir Stratejide Birleştirin!'
    ...
    const config = {
        hero: {
            title: 'Endüstriyel Gıda Sektörü İçin Dijital Kanalları Tek Bir Stratejide Birleştirin!',
