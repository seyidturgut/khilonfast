...
export default function FeaturesBlock({ data }: FeaturesBlockProps) {
    const {
        ...
        description = 'khilonfast olarak, iş büyümesini desteklemek için tasarlanmış ürün bazlı pazarlama çözümleri sunuyoruz.',
        features = [
            { title: 'Hedeflenmiş dijital kampanyalarımızla marka görünürlüğü artırın.' },
            { title: 'Veri odaklı pazarlama stratejilerimizle dönüşüm oranını artırın.' }
        ]
    } = data;
